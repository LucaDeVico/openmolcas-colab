...
Notebook 2 will be made public. It will contain a call to quickly wget the tarball, unzip it, and use it. There will be a way to create a (basic) input for OpenMolcas, run it, and visualize the output. For the latter, there will be the possibility to visualize geometric coordinates, molecular orbitals, and an extract of the main results, along with the ability to download the full set of output files.
